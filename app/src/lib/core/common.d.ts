...
declare abstract class agent extends handle { __agent: never; }
declare abstract class event extends agent { __event: never; }
declare abstract class player extends agent { __player: never; }
declare abstract class widget extends agent { __widget: never; }
declare abstract class unit extends widget { __unit: never; }
